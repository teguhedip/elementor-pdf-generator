...
<body>
    ...
    <div class="page">
        ...
        <div class="footer">
            <!-- <div class="footer-branch"><strong>Cabang 1:</strong> Jl. Gatot Kaca No. 338, Gedongkuning, Banguntapan, Bantul, DIY (Belakang JEC)</div>
            <div class="footer-branch"><strong>Cabang 2:</strong> Jl. Sulawesi VII No. 20, Purwosari, Sinduadi, Mlati, Sleman, DIY (Kentungan)</div>
            <div class="footer-branch"><strong>Cabang 3:</strong> Jl. Lingkar Timur Ringroad, Tirtango, Bantul, DIY (Selatan ATR/BPN Kab. Bantul)</div> -->
